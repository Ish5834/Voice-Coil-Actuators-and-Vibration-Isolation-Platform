...
## Goal of the project: 
Develop an in-house voice coil actuator and build a stewart platform based vibration isolation platform using these actuators. We intend to make a hybrid, table top vibration isolation platform. This platform should be able to hold about 100kg and damp out vibrations in the 1-10Hz range (for now)
